...
export class MultipleCorrespondenceAnalysis {
  free(): void;
  constructor(analysis_data: any, supplement_data: any, labeling_data: any, config_data: any, analysis_data_defs: any, supplement_data_defs: any, labeling_data_defs: any);
  get_results(): any;
