...
export class MultipleCorrespondenceAnalysis {
     ...
     */
    constructor(analysis_data, supplement_data, labeling_data, config_data, analysis_data_defs, supplement_data_defs, labeling_data_defs) {
        const ret = wasm.multiplecorrespondenceanalysis_new(analysis_data, supplement_data, labeling_data, config_data, analysis_data_defs, supplement_data_defs, labeling_data_defs);
        if (ret[2]) {
