...
export class Decomposition {
  free(): void;
  constructor(data: Float64Array, data_header: string, period: number);
  get_data(): Float64Array;
  get_data_header(): string;
...
export class Smoothing {
  free(): void;
  constructor(data_header: string, data: Float64Array);
  get_data_header(): string;
  get_data(): Float64Array;
  set_data_header(data_header: string): void;
  set_data(data: Float64Array): void;
...
export interface InitOutput {
  ...
  readonly decomposition_new: (a: number, b: number, c: number, d: number, e: number) => number;
  ...
  readonly smoothing_new: (a: number, b: number, c: number, d: number) => number;
