...
export const decomposition_new: (a: number, b: number, c: number, d: number, e: number) => number;
...
export const smoothing_new: (a: number, b: number, c: number, d: number) => number;
