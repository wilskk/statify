...
interface KIndependentSamplesModalProps {
    onClose: () => void;
}

const Index: FC<KIndependentSamplesModalProps> = ({ onClose }) => {
    ...
    // Grouping variable handling (from original KIndependentSamplesTestModal)
    ...
    // Group variable handlers from original KIndependentSamplesTestModal
                    ...
                    try {
                        ...
                        if (wData.testType.kruskalWallisH) {
                            ...
                            await addStatistic(analyticId, {
                                ...
                                output_data: wData.kruskalWallisH,
                                components: "Kruskal-Wallis Test",
                                description: ""
                            });
                        }
                        ...
                        if (wData.testType.median) {
                            // await addStatistic(analyticId, {
                            //     title: "Frequencies",
                            //     output_data: wData.medianFrequencies,
                        ...
                        if (wData.testType.jonckheereTerpstra) {
                            // await addStatistic(analyticId, {
                            //     title: "Test Statistics",
                            //     output_data: wData.jonckheereTerpstraTest,
    ...
    return (
        <DialogContent className="max-w-[800px] p-0 bg-white border border-[#E6E6E6] shadow-md rounded-md flex flex-col max-h-[85vh]">
            <DialogHeader className="px-6 py-4 border-b border-[#E6E6E6] flex-shrink-0">
                <DialogTitle className="text-[22px] font-semibold">Tests for Several Independent Samples</DialogTitle>
            </DialogHeader>
                ...
                <div className="flex justify-end space-x-3">
                    <Button
                        ...
                        disabled={
                            ...
                            !group2 ||
                            (
                                testType.kruskalWallisH === false &&
                                testType.median === false &&
                                testType.jonckheereTerpstra === false
                            )
                        }
                    >
