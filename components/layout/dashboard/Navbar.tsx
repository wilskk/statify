                        ...
                        <MenubarContent>
                            <MenubarSub>
                                ...
                                <MenubarSubContent>
                                    <MenubarItem
                                        onClick={() =>
                                            openModal(ModalType.Frequencies)
                                        }
                                    >
                                        Frequencies...
                                    </MenubarItem>
                                    <MenubarItem
                                        onClick={() =>
                                            openModal(ModalType.Descriptive)
                                        }
                                    >
                                        Descriptives...
                                    </MenubarItem>
