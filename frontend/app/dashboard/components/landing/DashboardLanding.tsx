...
export const DashboardLanding: React.FC<DashboardLandingProps> = ({ dataActions, resources }) => {
    return (
        <div className="container mx-auto px-4 py-12 max-w-6xl">
            <div className="mb-12">
                <h1 className="text-3xl font-semibold text-foreground mb-2">Welcome to Statify</h1>
                <p className="text-muted-foreground">Start statistical analysis or open an existing project.</p>
            </div>
