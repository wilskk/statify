            ...
            <Accordion type="multiple" className="w-full">
              ...
              <AccordionItem value="file" className="border-b border-border">
                ...
                <AccordionContent className="flex flex-col space-y-0.5 pl-4 pr-0 pb-1 pt-0 bg-background">
                  <DrawerMenuItem
                    onClick={() => handleAction({ actionType: "New" })}
                  >
                    New
                  </DrawerMenuItem>
                  <DrawerMenuItem
                    onClick={() => handleAction({ actionType: "Save" })}
                  >
                    Save
                  </DrawerMenuItem>
                  <DrawerMenuItem
                    onClick={() => handleAction({ actionType: "SaveAs" })}
                  >
                    Save As...
                  </DrawerMenuItem>
                  ...
                  <DrawerMenuSeparator />
                  <DrawerMenuItem
                    onClick={() => handleAction({ actionType: "Exit" })}
                  >
                    Exit
                  </DrawerMenuItem>
                </AccordionContent>
              ...
              <AccordionItem value="edit" className="border-b border-border">
                ...
                <AccordionContent className="flex flex-col space-y-0.5 pl-4 pr-0 pb-1 pt-0 bg-background">
                  <DrawerMenuItem
                    onClick={() => handleAction({ actionType: "Cut" })}
                  >
                    Cut
                  </DrawerMenuItem>
                  <DrawerMenuItem
                  ...
                  <DrawerMenuItem
                    onClick={() =>
                      handleAction({ actionType: "PasteVariables" })
                    }
                    disabled={false}
                  >
                    Paste Variables...
                  ...
                  <DrawerMenuItem
                    onClick={() =>
                      handleAction({ actionType: "InsertVariable" })
                    }
                    disabled={false}
                  >
                    Insert Variable
                        ...
                        <Accordion type="multiple" className="w-full">
                          ...
                          >
                            ...
                            <AccordionContent className="flex flex-col space-y-0.5 pl-4 pr-0 pb-1 pt-0 bg-background">
                              <DrawerMenuItem
                                onClick={() =>
                                  handleFileAction({ actionType: "New" })
                                }
                              >
                                New
                              </DrawerMenuItem>
                              <DrawerMenuItem
                                onClick={() =>
                                  handleFileAction({ actionType: "Save" })
                                }
                              >
                                Save
                              </DrawerMenuItem>
                              <DrawerMenuItem
                                onClick={() =>
                                  handleFileAction({ actionType: "SaveAs" })
                                }
                              >
                                Save As...
                              </DrawerMenuItem>
                              <DrawerMenuItem
                                onClick={() => openModal(ModalType.OpenData)}
                              >
                                Open Data
                              </DrawerMenuItem>
                              {/* Import Data Items */}
                              ...
                              <DrawerMenuSeparator />
                              <DrawerMenuItem
                                onClick={() => openModal(ModalType.Print)}
                              >
                                Print...
                              </DrawerMenuItem>
                              <DrawerMenuSeparator />
                              <DrawerMenuItem
                                onClick={() =>
                                  handleFileAction({ actionType: "Exit" })
                                }
                              >
                                Exit
                              </DrawerMenuItem>
                          ...
                          >
                            ...
                            <AccordionContent className="flex flex-col space-y-0.5 pl-4 pr-0 pb-1 pt-0 bg-background">
                              ...
                              <DrawerMenuItem
                                onClick={() =>
                                  handleEditAction("CopyWithVariableNames")
                                }
                                disabled={false}
                              >
                                Copy with Variable Names
                              ...
                              <DrawerMenuItem
                                onClick={() =>
                                  handleEditAction("CopyWithVariableLabels")
                                }
                                disabled={false}
                              >
                                Copy with Variable Labels
                              ...
                              <DrawerMenuItem
                                onClick={() =>
                                  handleEditAction("PasteVariables")
                                }
                                disabled={false}
                              >
                                Paste Variables...
                              ...
                              <DrawerMenuItem
                                onClick={() =>
                                  handleEditAction("PasteWithVariableNames")
                                }
                                disabled={false}
                              >
                                Paste with Variable Names
                              ...
                              <DrawerMenuSeparator />
                              <DrawerMenuItem
                                onClick={() => handleEditAction("Clear")}
                              >
                                Clear
                              </DrawerMenuItem>
                              <DrawerMenuSeparator />
                              <DrawerMenuItem
                                onClick={() =>
                                  handleEditAction("InsertVariable")
                                }
                                disabled={false}
                              >
                                Insert Variable
                          ...
                          >
                            ...
                            <AccordionContent className="flex flex-col space-y-0.5 pl-4 pr-0 pb-1 pt-0 bg-background">
                              ...
                              <DrawerMenuItem
                                onClick={() => openModal(ModalType.SortVars)}
                              >
                                Sort Variables...
                              </DrawerMenuItem>
                              {/* <DrawerMenuItem onClick={() => openModal(ModalType.Transpose)}>Transpose...</DrawerMenuItem> */}
                          ...
                          >
                            ...
                            <AccordionContent className="flex flex-col space-y-0.5 pl-4 pr-0 pb-1 pt-0 bg-background">
                              <DrawerMenuItem
                                onClick={() =>
                                  openModal(ModalType.ComputeVariable)
                                }
                              >
                                Compute Variable...
                              </DrawerMenuItem>
                              ...
                              <DrawerMenuItem
                                onClick={() =>
                                  openModal(ModalType.RecodeSameVariables)
                                }
                              >
                                Recode into Same Variables...
                              </DrawerMenuItem>
                              ...
                              <Accordion type="multiple" className="w-full">
                                ...
                                >
                                  ...
                                  <AccordionContent className="flex flex-col space-y-0.5 pl-3 pr-0 pb-1 pt-0 bg-accent">
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(
                                          ModalType.ModalAutomaticLinearModeling
                                        )
                                      }
                                    >
                                      Automatic Linear Modeling...
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.ModalLinear)
                                      }
                                    >
                                      Linear...
                                    </DrawerMenuItem>
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(
                                          ModalType.ModalCurveEstimation
                                        )
                                      }
                                    >
                                      Curve Estimation...
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(
                                          ModalType.ModalPartialLeastSquares
                                        )
                                      }
                                    >
                                      Partial Least Squares...
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(
                                          ModalType.ModalMultinomialLogistic
                                        )
                                      }
                                    >
                                      Multinomial Logistic...
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.ModalOrdinal)
                                      }
                                    >
                                      Ordinal...
                                    </DrawerMenuItem>
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.ModalProbit)
                                      }
                                    >
                                      Probit...
                                    </DrawerMenuItem>
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.ModalNonlinear)
                                      }
                                    >
                                      Nonlinear...
                                    </DrawerMenuItem>
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(
                                          ModalType.ModalWeightEstimation
                                        )
                                      }
                                    >
                                      Weight Estimation...
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(
                                          ModalType.ModalTwoStageLeastSquares
                                        )
                                      }
                                    >
                                      2-Stage Least Squares...
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.ModalQuantiles)
                                      }
                                    >
                                      Quantiles...
                                    </DrawerMenuItem>
                                ...
                                >
                                  ...
                                  <AccordionContent className="flex flex-col space-y-0.5 pl-3 pr-0 pb-1 pt-0 bg-accent">
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.Decomposition)
                                      }
                                    >
                                      Decomposition
                                    </DrawerMenuItem>
                                    ...
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.Autocorrelation)
                                      }
                                    >
                                      Autocorrelation
                                    </DrawerMenuItem>
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.UnitRootTest)
                                      }
                                    >
                                      Unit Root Test
                                    </DrawerMenuItem>
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.BoxJenkinsModel)
                                      }
                                    >
                                      Box-Jenkins Model
                                    </DrawerMenuItem>
                            ...
                            <AccordionContent className="pl-4 pr-0 pb-1 pt-0 bg-background">
                              <Accordion type="multiple" className="w-full">
                                ...
                                >
                                  <DrawerMenuItem
                                    onClick={() =>
                                      openModal(ModalType.ChartBuilderModal)
                                    }
                                  >
                                    Chart Builder...
                                  </DrawerMenuItem>
                                ...
                                >
                                  ...
                                  <AccordionContent className="flex flex-col space-y-0.5 pl-6 pr-0 pb-1 pt-0 bg-accent">
                                    <DrawerMenuItem
                                      onClick={() =>
                                        openModal(ModalType.SimpleBarModal)
                                      }
                                    >
                                      Bar...
                                    </DrawerMenuItem>
