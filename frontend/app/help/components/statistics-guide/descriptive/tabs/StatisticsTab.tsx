      ...
      <div className="space-y-4">
        ...
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            ...
            <span className="text-sm text-slate-600 dark:text-slate-400 ml-2">= nilai tengah dari data terurut</span>
          </div>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            <BlockMath math={'\\mathrm{Sum} = \\sum x'} />
          </div>
    ...
    <div className="p-5 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            <BlockMath math={'\\sigma = \\sqrt{\\dfrac{\\sum (x - \\bar{x})^2}{n}}'} />
          </div>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            <BlockMath math={'\\sigma^2 = \\dfrac{\\sum (x - \\bar{x})^2}{n}'} />
          </div>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            <BlockMath math={'\\mathrm{SE} = \\dfrac{\\sigma}{\\sqrt{n}}'} />
          </div>
    ...
    <div className="p-5 bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 shadow-sm">
      ...
      <div className="space-y-4">
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            <BlockMath math={'\\mathrm{Skew} = \\frac{1}{n} \\sum \\left( \\frac{x - \\bar{x}}{\\sigma} \\right)^3'} />
          </div>
        ...
        <div className="p-4 bg-white dark:bg-slate-900 rounded-lg border border-slate-300 dark:border-slate-600">
          ...
          <div className="bg-slate-100 dark:bg-slate-800 p-3 rounded border">
            <BlockMath math={'\\mathrm{Kurt} = \\frac{1}{n} \\sum \\left( \\frac{x - \\bar{x}}{\\sigma} \\right)^4 - 3'} />
          </div>
