    ...
    return (
        ...
        >
            ...
            <div className="prose max-w-none">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold text-yellow-800 mb-2">
                        Fungsi calculate_levene_test dalam function.rs:
                    </h4>
                    <p className="text-sm text-yellow-700">
                        Fungsi ini menghitung Levene's Test untuk menguji
                        homogenitas varians, termasuk statistik F, p-value, dan
                        degrees of freedom.
                    </p>
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg my-4">
                    ...
                    <ol className="text-sm text-blue-700 space-y-1">
                        <li>1. Menghitung median untuk setiap kelompok</li>
                        <li>2. Menghitung deviasi absolut dari median</li>
                        <li>3. Melakukan ANOVA pada deviasi absolut</li>
                        <li>4. Menghitung statistik F dan p-value</li>
                        <li>
                            5. Menghasilkan hasil untuk berbagai variasi test
                        </li>
                    </ol>
                </div>

                <h3>Variasi yang Dihitung</h3>
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold mb-2">
                        Berdasarkan Ada/Tidaknya Kovariat:
                    </h4>
                    <div className="text-sm text-gray-600 space-y-2">
                        <div>
                            <strong>Tidak Ada Kovariat:</strong>
                        </div>
                        <ul className="text-sm text-gray-600 mt-1 ml-4">
                            <li>• Based on Mean (Levene klasik)</li>
                            <li>• Based on Median (Brown-Forsythe)</li>
                            <li>• Based on Median with adjusted df</li>
                            <li>• Based on trimmed mean</li>
                        </ul>
                        <div>
                            <strong>Ada Kovariat:</strong>
                        </div>
                        <ul className="text-sm text-gray-600 mt-1 ml-4">
                            <li>• Levene (berdasarkan mean pada residual)</li>
                        </ul>
                    </div>
                </div>

                <h3>Penanganan Residual</h3>
                <div className="bg-yellow-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold text-yellow-800 mb-2">
                        Ketika Ada Kovariat:
                    </h4>
                    <div className="text-sm text-yellow-700 space-y-1">
                        <li>• Hitung residual dari model regresi</li>
                        <li>• Residual = Y - Ŷ</li>
                        <li>• Uji Levene pada residual</li>
                        <li>• Menghilangkan efek kovariat pada varians</li>
                    </div>
                </div>
