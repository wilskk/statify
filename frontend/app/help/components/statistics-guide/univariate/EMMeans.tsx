            ...
            <div className="prose max-w-none">
                ...
                <div className="bg-blue-50 p-4 rounded-lg my-4">
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                        <li>
                            <strong>calculate_emmeans:</strong> Fungsi utama
                            yang mengorkestrasi seluruh proses
                        </li>
                        <li>
                            <strong>generate_l_vectors_for_emmeans:</strong>{" "}
                            Membangun vektor-L untuk setiap EMM
                        </li>
                        <li>
                            <strong>generate_em_estimates_table:</strong>{" "}
                            Menghitung EMM, SE, dan CI
                        </li>
                        <li>
                            <strong>
                                generate_pairwise_comparisons_table:
                            </strong>{" "}
                            Perbandingan berpasangan
                        </li>
                        <li>
                            <strong>generate_univariate_test_table:</strong> Uji
                            univariat (uji-F)
                        </li>
                        <li>
                            <strong>generate_l_vector_for_grand_mean:</strong>{" "}
                            Vektor-L untuk grand mean
                        </li>
                    </ul>
                </div>

                <h3>Struktur Hasil EMMs</h3>
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold mb-2">EMMeansResult:</h4>
                    <div className="text-sm font-mono space-y-2">
                        <div>
                            <strong>parameter_names:</strong> Nama-nama
                            parameter model
                        </div>
                        <div>
                        ...
                        <div>
                            <strong>em_estimates:</strong> Tabel estimasi EMMs
                        </div>
                        <div>
                            <strong>pairwise_comparisons:</strong> Perbandingan
                            berpasangan (opsional)
                        </div>
                        <div>
                            <strong>univariate_tests:</strong> Uji univariat
                            (opsional)
                        </div>
                    </div>
                </div>

                <h3>Algoritma generate_l_vectors_for_emmeans</h3>
                <div className="bg-yellow-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold text-yellow-800 mb-2">
                        Langkah-langkah:
                    </h4>
                    <ol className="text-sm text-yellow-700 space-y-1">
                        <li>
                            1. Iterasi melalui setiap kombinasi level faktor
                        </li>
                        <li>
                            2. Buat vektor-L dengan panjang sama jumlah
                            parameter
                        </li>
                        <li>
                            3. Tentukan koefisien berdasarkan aturan konstruksi
                        </li>
                        <li>4. Cek estimability (vektor tidak semua nol)</li>
                        <li>5. Kumpulkan vektor-L dan label</li>
                    </ol>
                </div>
