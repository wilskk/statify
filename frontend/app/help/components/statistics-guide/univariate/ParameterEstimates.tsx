    ...
    return (
        ...
        >
            ...
            <div className="prose max-w-none">
                ...
                <h2 className="mt-8">Robust Standard Errors</h2>

                <p>
                    Ketika asumsi homoskedastisitas tidak terpenuhi, robust
                    standard errors dapat digunakan:
                </p>

                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <div className="text-center text-lg font-mono">
                        <strong>Var(β̂) = (X'X)⁻¹X'ΩX(X'X)⁻¹</strong>
                    </div>
                    <p className="mt-2 text-sm text-gray-600">
                        Dimana Ω adalah matriks variance-covariance error
                    </p>
                </div>

                <h3>Huber-White Standard Errors</h3>
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <div className="text-center text-lg font-mono">
                        <strong>Ω = diag(ε̂²ᵢ)</strong>
                    </div>
                    <p className="mt-2 text-sm text-gray-600">
                        Estimasi heteroskedastisitas-consistent standard errors
                    </p>
                </div>

                <h2 className="mt-8">Effect Size untuk Parameter</h2>

                <h3>Standardized Coefficients</h3>
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <div className="text-center text-lg font-mono">
                        <strong>β*ᵢ = βᵢ × (σₓ / σᵧ)</strong>
                    </div>
                    <p className="mt-2 text-sm text-gray-600">
                        Dimana σₓ dan σᵧ adalah standard deviation X dan Y
                    </p>
                </div>

                <h3>Semi-Partial Correlation</h3>
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <div className="text-center text-lg font-mono">
                        <strong>srᵢ = β*ᵢ × √(1 - R²ᵢ)</strong>
                    </div>
                    <p className="mt-2 text-sm text-gray-600">
                        Korelasi unik antara prediktor i dan variabel dependen
                    </p>
                </div>
                ...
                <div className="bg-yellow-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold text-yellow-800 mb-2">
                        Fungsi calculate_parameter_estimates dalam function.rs:
                    </h4>
                    <p className="text-sm text-yellow-700">
                        Fungsi ini menghitung parameter estimates berdasarkan
                        model yang dipilih, termasuk standard errors,
                        t-statistics, dan confidence intervals.
                    </p>
                </div>

                <h3>Algoritma Implementasi</h3>
                <div className="bg-blue-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold text-blue-800 mb-2">
                        Langkah-langkah dalam Statify:
                    </h4>
                    <ol className="text-sm text-blue-700 space-y-1">
                        <li>1. Membangun matriks desain X sesuai model</li>
                        <li>2. Menghitung estimasi parameter β̂ = (X'X)⁻¹X'y</li>
                        <li>3. Menghitung residual dan MSE</li>
                        <li>4. Menghitung covariance matrix Var(β̂)</li>
                        <li>5. Menghitung standard errors dan t-statistics</li>
                        <li>6. Menghitung confidence intervals</li>
                        <li>7. Menghitung standardized coefficients</li>
                    </ol>
                </div>
