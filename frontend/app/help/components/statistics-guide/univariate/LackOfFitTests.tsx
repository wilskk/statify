        ...
        >
            ...
            <div className="prose max-w-none">
                ...
                <div className="bg-blue-50 p-4 rounded-lg my-4">
                    ...
                    <ul className="text-sm text-blue-700 space-y-1">
                        <li>
                            <strong>calculate_lack_of_fit_tests:</strong> Fungsi
                            utama orkestrasi
                        </li>
                        <li>
                            <strong>hash_dvector_row:</strong> Hash baris X
                            untuk pengelompokan
                        </li>
                        <li>
                        ...
                        <li>
                            <strong>calculate_mean:</strong> Hitung rata-rata
                            grup
                        </li>
                    </ul>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold mb-2">LackOfFitTests:</h4>
                    <div className="text-sm font-mono space-y-2">
                        <div>
                            <strong>lack_of_fit:</strong> Statistik untuk lack
                            of fit
                        </div>
                        <div>
                            <strong>pure_error:</strong> Statistik untuk pure
                            error
                        </div>
                        <div>
                            <strong>note:</strong> Catatan tentang perhitungan
                        </div>
                        <div>
                ...
                <h3>Komponen LackOfFitTestsEntries</h3>
                <div className="bg-yellow-50 p-4 rounded-lg my-4">
                    <h4 className="font-bold text-yellow-800 mb-2">
                        Setiap entry berisi:
                    </h4>
                    <ul className="text-sm text-yellow-700 space-y-1">
                        <li>
                            <strong>sum_of_squares:</strong> SS_LOF atau SS_PE
                        </li>
                        <li>
                            <strong>df:</strong> Degrees of freedom
                        </li>
                        <li>
                            <strong>mean_square:</strong> MS_LOF atau MS_PE
                        </li>
                        <li>
                            <strong>f_value:</strong> Statistik F (hanya untuk
                            lack of fit)
                        </li>
                        <li>
                            <strong>significance:</strong> p-value
                        </li>
                        <li>
                            <strong>partial_eta_squared:</strong> Effect size
                        </li>
                        <li>
                            <strong>noncent_parameter:</strong> Parameter
                            noncentral
                        </li>
                        <li>
                            <strong>observed_power:</strong> Power observasi
                        </li>
                    </ul>
                </div>
