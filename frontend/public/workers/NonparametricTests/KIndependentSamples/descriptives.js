...
export function resultDescriptive(data, variables, groupData, groupingVariable, displayStatistics) {
    ...
    const groupStats = computeDescriptiveStats([groupArrays], displayStatistics, [groupingVariable]);
        ...
        tables: [
            {
                ...
                rows: [...descriptiveStats.rows, ...groupStats.rows]
            }
        ]
    };
}
