...
import { InfoIcon, RefreshCw } from "lucide-react"; // Removed FileIcon, ArrowLeft, Settings2 as they are part of modal shell
        ...
        <>
            ...
            <div className="px-6 py-4 border-t border-border bg-muted flex-shrink-0 flex justify-between items-center">
                ...
                <div className="flex space-x-2">
                    <Button variant="outline" onClick={onBack} disabled={isProcessing} className="h-9">Back</Button> 
