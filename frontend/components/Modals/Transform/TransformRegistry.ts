 ...
 */
export const TRANSFORM_MODAL_COMPONENTS: Record<string, ComponentType<BaseModalProps>> = {
 ...
 */
export function getTransformModalComponent(type: ModalType): ComponentType<BaseModalProps> | null {
 ...
 */
export const TRANSFORM_MODAL_CONTAINER_PREFERENCES: Partial<Record<ModalType, "dialog" | "sidebar">> = {
