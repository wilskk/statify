...
interface DateTimeService {
  ...
  dataGeneration: {
    ...
    generateDateStrings: (timeValues: TimeValues[], format: string) => string[];
    populateSampleRows: (
      variables: VariableDefinition[],
      data: any[][],
      rowCount: number,
...
const batchUpdateCells = (updates: CellUpdate[], batchSize: number = 1000) => {
...
| Case | DAY\_ | HOUR\_ | MINUTE\_ | DATE\_      |
| :--- | :---- | :----- | :------- | :---------- |
