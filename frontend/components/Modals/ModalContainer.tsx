...
import ComputeVariableModal from "@/components/Modals/Transform/ComputeVariable/ComputeVariableModal";
import RecodeSameVariablesModal from "@/components/Modals/Transform/recodeSameVariables";
import RecodeDifferentVariables from "./Transform/recodeDifferentVariables";
...
import {
  CompareMeansModal,
  isCompareMeansModal,
} from "@/components/Modals/Analyze/CompareMeans/CompareMeansModal";
import {
  LegacyDialogsModal,
  isLegacyDialogsModal,
} from "@/components/Modals/Analyze/NonparametricTests/LegacyDialogs/LegacyDialogsModal";
import {
  ...
  const renderModal = () => {
    ...
    switch (currentModal.type) {
      ...
      case ModalType.RecodeSameVariables:
        return <RecodeSameVariablesModal onClose={closeModal} />;
      case ModalType.RecodeDifferentVariables:
        return <RecodeDifferentVariables onClose={closeModal} />;
