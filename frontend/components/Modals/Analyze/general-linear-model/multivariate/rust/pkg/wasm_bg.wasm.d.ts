...
export const __wbg_multivariateanalysis_free: (a: number, b: number) => void;
export const multivariateanalysis_clear_errors: (a: number) => any;
export const multivariateanalysis_get_all_errors: (a: number) => any;
