...
export class UnivariateAnalysis {
     ...
     */
    get_all_log() {
        const ret = wasm.univariateanalysis_get_all_log(this.__wbg_ptr);
        if (ret[2]) {
...
if (Symbol.dispose) UnivariateAnalysis.prototype[Symbol.dispose] = UnivariateAnalysis.prototype.free;
