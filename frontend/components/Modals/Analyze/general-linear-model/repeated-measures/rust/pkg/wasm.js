...
export class RepeatedMeasureAnalysis {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        RepeatedMeasureAnalysisFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_repeatedmeasureanalysis_free(ptr, 0);
    }
    /**
     * @returns {any}
     */
    clear_errors() {
        const ret = wasm.repeatedmeasureanalysis_clear_errors(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {any}
     */
    get_all_errors() {
        const ret = wasm.repeatedmeasureanalysis_get_all_errors(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {any}
    ...
    get_executed_functions() {
        const ret = wasm.repeatedmeasureanalysis_get_executed_functions(this.__wbg_ptr);
        if (ret[2]) {
    ...
    get_formatted_results() {
        const ret = wasm.repeatedmeasureanalysis_get_formatted_results(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     */
    get_results() {
        const ret = wasm.repeatedmeasureanalysis_get_results(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
     ...
     * @param {any} factors_data
     * @param {any} covar_data
     * @param {any} subject_data_defs
     * @param {any} factors_data_defs
     * @param {any} covar_data_defs
     * @param {any} config_data
     */
    constructor(subject_data, factors_data, covar_data, subject_data_defs, factors_data_defs, covar_data_defs, config_data) {
        const ret = wasm.repeatedmeasureanalysis_new(subject_data, factors_data, covar_data, subject_data_defs, factors_data_defs, covar_data_defs, config_data);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0];
        RepeatedMeasureAnalysisFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
}
if (Symbol.dispose) RepeatedMeasureAnalysis.prototype[Symbol.dispose] = RepeatedMeasureAnalysis.prototype.free;
...
const RepeatedMeasureAnalysisFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_repeatedmeasureanalysis_free(ptr, 1));
