...
const KIndependentSamplesContent: FC<BaseModalProps> = ({ onClose }) => {
    ...
    const { isLoading, errorMsg, runAnalysis, cancelAnalysis } = useKIndependentSamplesAnalysis({
        testVariables,
        groupingVariable,
        group1,
        group2,
        ...
        return (
            <div className="h-full flex flex-col overflow-hidden bg-popover text-popover-foreground">
                <div className="flex-grow flex flex-col overflow-hidden">
                    <KIndependentSamplesContent onClose={onClose} />
                </div>
            </div>
        );
    }
