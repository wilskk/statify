    ...
    return (
        <div className="grid grid-cols-12 gap-2">
            ...
            <div className="col-span-6" style={{height: "340px"}}>
                <div className="text-sm mb-2 font-medium">Test Pairs:</div>
                <div className="border border-[#E6E6E6] rounded-md overflow-auto" style={{height: "288px"}}>
                    <Table>
                        <TableHeader>
                            <TableRow>
            ...
            <div className="col-span-2 flex flex-col items-center justify-start gap-4 pt-8">
                <Button
                    variant="outline"
                    size="sm"
                    className="p-0 w-8 h-8 border-[#CCCCCC] hover:bg-[#F7F7F7] hover:border-[#888888]"
            ...
            <div className="col-span-12 mt-4">
                ...
                <div className="border p-4 rounded-md flex flex-wrap gap-6 items-center">
                    <div className="flex items-center">
                        <Checkbox
                            id="wilcoxon-option"
                            checked={testType.wilcoxon}
                            onCheckedChange={(checked) => setTestType({ ...testType, wilcoxon: !!checked })}
                            className="mr-2 border-[#CCCCCC]"
                        />
                        <Label htmlFor="wilcoxon-option">Wilcoxon</Label>
                    </div>
                    <div className="flex items-center">
                        <Checkbox
                            id="sign-option"
                            checked={testType.sign}
                            onCheckedChange={(checked) => setTestType({ ...testType, sign: !!checked })}
                            className="mr-2 border-[#CCCCCC]"
                        />
                        <Label htmlFor="sign-option">Sign</Label>
                    </div>
                    <div className="flex items-center">
                        <Checkbox
                            id="mcnemar-option"
                    ...
                    <div className="flex items-center">
                        <Checkbox
                            id="marginal-homogeneity-option"
