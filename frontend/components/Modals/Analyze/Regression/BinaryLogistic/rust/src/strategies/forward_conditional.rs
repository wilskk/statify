...
fn format_result(
    ...
    Ok(LogisticResult {
        ...
        variables_not_in_equation: vars_not_in, // FIX ERROR 2: Field ini sekarang terisi
        omni_tests: omni,
        step_history: Some(history),   // FIX ERROR 1: Dibungkus Some()
        block_0_constant: block_0_row, // FIX ERROR 3: Menggunakan data struct konkret
    })
}
