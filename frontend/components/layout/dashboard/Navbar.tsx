            ...
            <MenubarContent>
              ...
              <MenubarSub>
                ...
                <MenubarSubContent>
                  ...
                  <MenubarItem
                    onClick={() => openModal(ModalType.IndependentSamplesTTest)}
                  >
                    Independent-Samples T Test...
                  </MenubarItem>
                  <MenubarItem
                    onClick={() => openModal(ModalType.PairedSamplesTTest)}
                  >
                ...
                <MenubarSubContent>
                  ...
                  <MenubarSub>
                    ...
                    <MenubarSubContent>
                      ...
                      <MenubarItem
                        onClick={() => openModal(ModalType.KIndependentSamples)}
                      >
                        K Independent Samples...
                      </MenubarItem>
                      <MenubarItem
                        onClick={() => openModal(ModalType.TwoRelatedSamples)}
                      >
                        2 Related Samples...
                      </MenubarItem>
                      <MenubarItem
                        onClick={() => openModal(ModalType.KRelatedSamples)}
                      >
                        K Related Samples...
                      </MenubarItem>
                    </MenubarSubContent>
